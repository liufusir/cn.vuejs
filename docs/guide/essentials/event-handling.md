...
你可以直接使用 <code>[KeyboardEvent.key](https://developer.mozilla.org/zh-CN/docs/Web/API/UI_Events/Keyboard_event_key_values)</code> 暴露的按键名称作为修饰符，但需要转为 kebab-case 形式。
