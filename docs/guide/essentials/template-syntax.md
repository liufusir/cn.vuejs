...
<div class="demo">
<p>Using text interpolation: <span style="color: red">This should be red.</span></p><p>Using v-html directive: <span><span style="color: red">This should be red.</span></span></p></div>
...
```
# 受限的全局访问​{#restricted-global-access}
